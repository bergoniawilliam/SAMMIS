                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex justify-between space-x-2">
                                <button
                                    wire:click="editUser({{ $user->id }})"class="block text-white bg-blue-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" data-modal-target="user-modal" data-modal-toggle="user-modal" >Edit</button>
                                <button
                                    wire:click="deleteUser({{ $user->id }})"class="block text-white bg-red-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" data-modal-target="delete-user-modal" data-modal-toggle="delete-user-modal">Delete</button>
                            </div>
                        </td>
                    </tr>
                @endforeach

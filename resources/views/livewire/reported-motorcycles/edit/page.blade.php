<div class="space-y-4">
    ...
    <div class="flex justify-between">
        ...
        <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" wire:click="nextForm" {{ $disableNextButton ? 'disabled' : '' }}>Next</button>
    </div>
</div>

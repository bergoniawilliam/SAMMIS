<div class="space-y-8">
    ...
    <div class="space-y-8" wire:init = "populateForms">
        ...
        <div class="{{ $currentForm === 1 ? 'block' : 'hidden' }}">
            @livewire('reported-motorcycles.view.motorcycle')
        </div>
        <!-- Reporter Form -->
        <div class="{{ $currentForm === 2 ? 'block' : 'hidden' }}">
            @livewire('reported-motorcycles.view.reporter')
        </div> 
        <!-- Owner Form -->
        <div class="{{ $currentForm === 3 ? 'block' : 'hidden' }}">
            @livewire('reported-motorcycles.view.owner')
        </div>
        <div class="{{ $currentForm === 4 ? 'block' : 'hidden' }}">
            @livewire('reported-motorcycles.view.status')
        </div>
    </div>

<div>
    ...
    <div class="space-y-4">
        <h1 class="text-2xl font-bold">Reporter Info View</h1>
            ...
            <div class="border p-4 shadow-md rounded-lg">
                ...
                <div>
                    ...
                    <input type="text" wire:model.lazy="middle_name_reporter" id="middle_name_reporter" name="middle_name_reporter"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        placeholder="Type Middle Name"  readonly>
                ...
                <div>
                    ...
                    <input type="text" wire:model.lazy="qualifier_reporter" id="qualifier_reporter" name="qualifier_reporter"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        placeholder="Type Qualifier"  readonly>
                ...
                <div>
                    ...
                    <input type="number" wire:model.lazy="cellphone_number_reporter" id="cellphone_number_reporter" name="cellphone_number_reporter"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        placeholder="Type Cellphone Number"  readonly>
            ...
            <div class="border p-4 shadow-md rounded-lg"
                ...
                <div>
                    ...
                    <input type="text" wire:input="clearProvince_reporter" wire:change="updateProvincesList_reporter()"
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"   readonly />
                ...
                <div>
                    ...
                    <input type="text" wire:model.lazy="home_unit_number_reporter" id="home_unit_number_reporter" name="home_unit_number_reporter"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        placeholder="Type Home/Unit Number"  readonly>

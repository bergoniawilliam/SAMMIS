<div>
    <div class="flex justify-between item-center">
        ...
        @can('create reportedmotorcycle')
            <a href="{{ route('reported-motorcycles.add') }}"
    ...
    <div>
        ...
        <div class="flex items-center mb-4 gap-2">
            <input wire:model.defer="search" type="text" placeholder="Search"
                class="px-3 py-2 rounded-lg border focus:outline-none focus:ring-primary-500 focus:border-primary-500" />
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <div class="flex space-x-2">
                                @can('update reportedmotorcycle')
                                    <a href="/reported-motorcycles/edit/{{ $reported_motorcycle->id }}"
                                        class="block text-white bg-blue-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Edit</a>
                                @endcan
